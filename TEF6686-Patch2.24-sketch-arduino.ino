/*
  by Eustake (marsel90)
  With this sketch it is recommended to use together with TEF-GTK v1.1.1
  changes: 
...
const uint16_t FMFilterMap[32] PROGMEM = { 0, 560, 640, 720, 840, 970, 1140, 1330, 1510, 1680, 1840, 2000, 2170, 2360, 2540, 2870, 3110 };
