...
by Eustake (marsel90)
  ...
  Sketch compatible with NXP-TEF6686(F8602-F8605)
  Tuner_Patch_Lithio_V102_p224
...
static const uint8_t DSP_INIT[] PROGMEM =
{
  ...
  0x02, INIT_FLAG_TIMER, 100,             // wait 100ms
  ...
  0x0D, 0x1B, 0xF0, 0x00, 0x10, 0x00, 0xF0, 0x00, 0xF0, 0x00, 0x70, 0x00, 0xD0, 0x08,// End of DSP_INIT bytes & Patch 2.24
  0x03, 0x1C, 0x00, 0x00,                                           // Clear Required Initialization Control
  ...
  0x17, 0x1B, 0x63, 0x69, 0x64, 0x3B, 0x66, 0x09, 0x66, 0xE7, 0x67, 0x0B, 0x67, 0x1A, 0x67, 0x29, 0x68, 0x87, 0x68, 0x99, 0x68, 0xA7, 0x68, 0xB2, //End LutByteValues
  0x03, 0x1C, 0x00, 0x00,                                           // Clear Required Initialization Control
...
static const uint8_t INIT_SET2[] PROGMEM =
{
  ...
  0x0B, 0x20, 0x28, 0x01, 0x00, 0x3C, 0x00, 0x78, 0x00, 0x0A, 0x00, 0x14,                                      // FM 40 Set_Softmute_Time          (1, 60, 120, 10, 20)
  0x0B, 0x20, 0x29, 0x01, 0x00, 0x01, 0x00, 0xB4, 0x00, 0x8C, 0x01, 0x04,                                      // FM 41 Set_Softmute_ Mod          (1, 1, 180, 140, 260)    
  0x09, 0x20, 0x2A, 0x01, 0x00, 0x01, 0x00, 0x64, 0x00, 0xFA,                                                  // FM 42 Set_Softmute_Level         (1, 1, 100, 250)          
  ...
  0x0B, 0x20, 0x32, 0x01, 0x00, 0xC8, 0x01, 0xF4, 0x00, 0x0A, 0x00, 0x50,                                      // FM 50 Set_Highcut_Time           (1, 200, 500, 10, 80)   
  0x0B, 0x20, 0x33, 0x01, 0x00, 0x01, 0x01, 0x90, 0x00, 0xC8, 0x03, 0x20,                                      // FM 51 Set_Highcut_ Mod           (1, 1, 400, 200, 800)   
  0x09, 0x20, 0x34, 0x01, 0x00, 0x01, 0x01, 0xF4, 0x00, 0xC8,                                                  // FM 52 Set_Highcut_Level          (1, 1, 500, 200)        
  0x09, 0x20, 0x35, 0x01, 0x00, 0x01, 0x00, 0x64, 0x00, 0x64,                                                  // FM 53 Set_Highcut_Noise          (1, 1, 100, 100)        
  0x09, 0x20, 0x36, 0x01, 0x00, 0x01, 0x00, 0x64, 0x00, 0x64,                                                  // FM 54 Set_HighCut_Mph            (1, 1, 100, 100)        
  0x07, 0x20, 0x37, 0x01, 0x00, 0x01, 0x09, 0x60,                                                              // FM 55 Set_HighCut_Max            (1, 1, 2400)        
  0x07, 0x20, 0x38, 0x01, 0x00, 0x01, 0x27, 0x10,                                                              // FM 56 Set_Highcut_Min            (1, 1, 10000)           
  0x07, 0x20, 0x39, 0x01, 0x00, 0x01, 0x00, 0x78,                                                              // FM 57 Set_Lowcut_Max             (1, 1, 120)             
  0x07, 0x20, 0x3A, 0x01, 0x00, 0x01, 0x00, 0x14,                                                              // FM 58 Set_Lowcut_Min             (1, 1, 20)                               
  0x0B, 0x20, 0x3C, 0x01, 0x00, 0x3C, 0x00, 0x78, 0x00, 0x0A, 0x00, 0x14,                                      // FM 60 Set_Stereo_Time            (1, 60, 120, 10, 20)
  0x0B, 0x20, 0x3D, 0x01, 0x00, 0x01, 0x00, 0xC8, 0x00, 0xC8, 0x03, 0xE8,                                      // FM 61 Set_Stereo_Mod             (1, 1, 200, 200, 1000)            
  0x09, 0x20, 0x3E, 0x01, 0x00, 0x01, 0x01, 0xF4, 0x00, 0xFA,                                                  // FM 62 Set_Stereo_Level           (1, 1, 500, 250)            
  0x09, 0x20, 0x3F, 0x01, 0x00, 0x01, 0x00, 0x64, 0x00, 0x64,                                                  // FM 63 Set_Stereo_Noise           (1, 1, 100, 100)            
  0x09, 0x20, 0x40, 0x01, 0x00, 0x01, 0x00, 0x64, 0x00, 0x64,                                                  // FM 64 Set_Stereo_Mph             (1, 1, 100, 100)            
  0x05, 0x20, 0x41, 0x01, 0x00, 0x01,                                                                          // FM 65 Set_Stereo_Max             (1, 1)                      
  0x07, 0x20, 0x42, 0x01, 0x00, 0x00, 0x01, 0x90,                                                              // FM 66 Set_Stereo_Min             (1, 1, 400)               
  0x0B, 0x20, 0x46, 0x01, 0x00, 0x78, 0x02, 0xEE, 0x00, 0x28, 0x00, 0x78,                                      // FM 70 Set_StHiBlend_Time         (1, 120, 750, 40, 120)      
  0x0B, 0x20, 0x47, 0x01, 0x00, 0x01, 0x00, 0xF0, 0x00, 0x78, 0x03, 0x02,                                      // FM 71 Set_StHiBlend_Mod          (1, 1, 240, 120, 770)       
  0x09, 0x20, 0x48, 0x01, 0x00, 0x01, 0x01, 0x2C, 0x01, 0x2C,                                                  // FM 72 Set_StHiBlend_Level        (1, 1, 300, 300)            
  ...
  0x07, 0x20, 0x4B, 0x01, 0x00, 0x01, 0xBB, 0x80,                                                              // FM 75 Set_StHiBlend_Max          (1, 1, 3000)                          
