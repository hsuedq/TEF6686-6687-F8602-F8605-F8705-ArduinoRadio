...
uint32_t freq;
int8_t Filter_AM = 16;
int8_t Filter_FM = 17; //Auto + 16 fixed bandwidth filters 
int8_t radio_mode;
int8_t scan_mode;
...
const uint16_t FMFilterMap[] PROGMEM = { 0, 560, 640, 720, 840, 970, 1140, 1330, 1510, 1680, 1840, 2000, 2170, 2360, 2540, 2870, 3110 };
