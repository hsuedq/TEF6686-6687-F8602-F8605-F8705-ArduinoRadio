...
{
  /*FM_add_and_improved_settings by eustake*/  
  0x11, 0x20, 0x17, 0x01, 0x00, 0x01, 0x03, 0xE8, 0x00, 0x00, 0x02, 0xBC, 0x00, 0x01, 0x00, 0x8C, 0x0C, 0x80,  // FM 23 Set_NoiseBlanker           (1, 1, 1000, 0, 700, 1, 140, 3200)                                                                      
  ...
  0x09, 0x20, 0x2A, 0x01, 0x00, 0x01, 0x00, 0x78, 0x00, 0xDC,                                                  // FM 42 Set_Softmute_Level         (1, 1, 120, 220)          
  ...
  0x09, 0x20, 0x35, 0x01, 0x00, 0x01, 0x01, 0x68, 0x01, 0x2C,                                                  // FM 53 Set_Highcut_Noise          (1, 1, 360, 300)        
  0x09, 0x20, 0x36, 0x01, 0x00, 0x01, 0x01, 0x68, 0x01, 0x2C,                                                  // FM 54 Set_HighCut_Mph            (1, 1, 360, 300)        
  0x07, 0x20, 0x37, 0x01, 0x00, 0x01, 0x09, 0x60,                                                              // FM 55 Set_HighCut_Max            (1, 1, 2400)        
  0x07, 0x20, 0x38, 0x01, 0x00, 0x01, 0x27, 0x10,                                                              // FM 56 Set_Highcut_Min            (1, 1, 10000)           
  0x07, 0x20, 0x39, 0x01, 0x00, 0x01, 0x00, 0x78,                                                              // FM 57 Set_Lowcut_Max             (1, 1, 120)             
  0x07, 0x20, 0x3A, 0x01, 0x00, 0x01, 0x00, 0x14,                                                              // FM 58 Set_Lowcut_Min             (1, 1, 20)                               
...
static const uint8_t INIT_SET3[] PROGMEM =
{
  ...
  0x11, 0x20, 0x17, 0x01, 0x00, 0x01, 0x03, 0xE8, 0x00, 0x00, 0x02, 0xBC, 0x00, 0x01, 0x00, 0x8C, 0x10, 0x68,  // FM 23 Set_NoiseBlanker           (1, 1, 1000, 0, 700, 1, 140, 4200) 
...
void loop()
{
  ...
  if ((millis() - timer) >= TIMER_INTERVAL)
  {
    if (radio_mode == FM) {
      ...
      Serial.print(uQuality[1] / 10, DEC);
      Serial.print(',');
      if ((uQuality[2] > 1000) && (radio_mode ==FM)) {uQuality[2] = 1000;} 
     ...
     else if (radio_mode == AM) {
      Serial.print("Sm");
      int16_t uQuality[4] = { 0 };
      Get_Cmd(33, 128, uQuality, 4);
      Serial.print(uQuality[1] / 10, DEC);
      Serial.print(',');
      if (radio_mode ==AM){uQuality[2] = uQuality[2] / 5;}
      Serial.print(uQuality[2] / 10, DEC);
      Serial.print(',');
      Serial.print(uQuality[3] / 10, DEC);
      Serial.print('\n');
    ...
    if (buff[buff_pos] != '\n' && buff_pos != SERIAL_BUFFER_SIZE - 1)
      ...
      switch (buff[0])
      {
        ...
        case 'V':      // Set AM lna (in TEF-GTK enable Show antenna input alignment) (NO FM)
          ...
          if (radio_mode == AM) {Set_Cmd(33, 12, 1, Level);}
          Serial.print('V');
          Serial.println(buff + 1);
          break;
