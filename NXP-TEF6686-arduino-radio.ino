...
static const uint8_t INIT_TEFSET1[] PROGMEM =
{
  ...
  0x07, 0x20, 0x42, 0x01, 0x00, 0x01, 0x00, 0x78,                                                              // FM 66 Set_Stereo_Min             (1, 1, 60)                
...
static const uint8_t INIT_TEFSET2[] PROGMEM =
{
  /*FM_add_and_improved_settings by eustake*/                                                                         
  0x07, 0x20, 0x17, 0x01, 0x00, 0x01, 0x03, 0xE8,                                                              // FM 23 Set_NoiseBlanker           (1, 1, 1000)
  0x09, 0x20, 0x18, 0x01, 0x01, 0x2C, 0x01, 0x2C, 0x00, 0xFA,                                                  // FM 24 Set_NoiseBlanker_Options   (1, 300, 300, 250)
  ...
  0x09, 0x20, 0x40, 0x01, 0x00, 0x01, 0x02, 0x58, 0x00, 0xDC,                                                  // FM 64 Set_Stereo_Mph             (1, 1, 600, 220)            
  0x05, 0x20, 0x41, 0x01, 0x00, 0x01,                                                                          // FM 65 Set_Stereo_Max             (1, 1)                      
  0x07, 0x20, 0x42, 0x01, 0x00, 0x01, 0x00, 0x3C,                                                              // FM 66 Set_Stereo_Min             (1, 1, 60)                
  0x0B, 0x20, 0x46, 0x01, 0x00, 0x78, 0x00, 0xFA, 0x00, 0x50, 0x00, 0x28,                                      // FM 70 Set_StHiBlend_Time         (1, 120, 250, 80, 40)     
  0x0B, 0x20, 0x47, 0x01, 0x00, 0x01, 0x00, 0xF0, 0x00, 0x78, 0x02, 0x9E,                                      // FM 71 Set_StHiBlend_Mod          (1, 1, 240, 120, 670)       
  0x09, 0x20, 0x48, 0x01, 0x00, 0x01, 0x01, 0xF4, 0x01, 0x2C,                                                  // FM 72 Set_StHiBlend_Level        (1, 1, 500, 300)            
  0x09, 0x20, 0x49, 0x01, 0x00, 0x01, 0x00, 0x50, 0x00, 0xA0,                                                  // FM 73 Set_StHiBlend_Noise        (1, 1, 80, 160)            
...
static const uint8_t INIT_TEFSET3[] PROGMEM =
{
  ...
  0x05, 0x20, 0x41, 0x01, 0x00, 0x01,                                                                          // FM 65 Set_Stereo_Max             (1, 1)                      
  0x07, 0x20, 0x42, 0x01, 0x00, 0x01, 0x01, 0x90,                                                              // FM 66 Set_Stereo_Min             (1, 1, 200)
...
static const uint8_t INIT_TEFSET4[] PROGMEM =
{
      ...
      switch (buff[0])
      {
       ...
       case 'C':
        ...
        case 'Z':
          Serial.print('Z');
          if (buff[1] == '0') {
              dsp_write_data(INIT_TEFSET1);
            Serial.print("0");
          } else if (buff[1] == '1') {
              dsp_write_data(INIT_TEFSET2);
            Serial.print("1");
          } else if (buff[1] == '2') {
              dsp_write_data(INIT_TEFSET3);
            Serial.print("2");
          } else if (buff[1] == '3') {
              dsp_write_data(INIT_TEFSET4);
            Serial.print("3");
          } else {
            Serial.print("4");
          }
