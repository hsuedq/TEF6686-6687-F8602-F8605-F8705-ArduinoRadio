/*
  ...
  ChannelEqualizer obtion - use the antenna rotor buttons (clockwise) to enable/off
  MphSuppression iMS obtion - use antenna rotor buttons (counterclockwise) to enable/off
