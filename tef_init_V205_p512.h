...
static const uint8_t INIT_SET2[] PROGMEM =
{
  ...
  0x07, 0x20, 0x17, 0x01, 0x00, 0x00, 0x00, 03E8,                                                              // FM 23 Set_NoiseBlanker           (1, 0, 1000)                           
  0x07, 0x20, 0x18, 0x01, 0x00, 0xD2, 0x00, 0xFA,                                                              // FM 24 Set_NoiseBlanker_Options   (1, 210, 210, 250)                     
  0x05, 0x20, 0x1F, 0x01, 0x02, 0xEE,                                                                          // FM 31 Set_Deemphasis             (1, 500)                         
  ...
  0x0B, 0x20, 0x28, 0x01, 0x00, 0x78, 0x01, 0xF4, 0x00, 0x14, 0x00, 0x14,                                      // FM 40 Set_Softmute_Time          (1, 120, 500, 20, 20)                 
  0x09, 0x20, 0x2A, 0x01, 0x00, 0x02, 0x00, 0x96, 0x00, 0xDC,                                                  // FM 42 Set_Softmute_Level         (1, 2, 150, 220)                    
  0x09, 0x20, 0x2B, 0x01, 0x00, 0x00, 0x01, 0xF4, 0x03, 0xE8,                                                  // FM 43 Set_Softmute_Noise         (1  0  500, 1000)                     
  0x09, 0x20, 0x2C, 0x01, 0x00, 0x00, 0x01, 0xF4, 0x03, 0xE8,                                                  // FM 44 Set_Softmute_Mph           (1, 0, 500  1000)                     
  0x07, 0x20, 0x2D, 0x01, 0x00, 0x00, 0x00, 0xF0,                                                              // FM 45 Set_Softmute_Max           (1, 0  200)                            
  0x0B, 0x20, 0x32, 0x01, 0x01, 0xF4, 0x07, 0xD0, 0x00, 0x14, 0x00, 0x14,                                      // FM 50 Set_Highcut_Time           (1, 500, 2000  20, 20)                 
  ...
  0x09, 0x20, 0x35, 0x01, 0x00, 0x02, 0x01, 0x68, 0x01, 0x2C,                                                  // FM 53 Set_Highcut_Noise          (1, 2, 360, 300)                    
  0x09, 0x20, 0x36, 0x01, 0x00, 0x02, 0x01, 0x68, 0x01, 0x2C,                                                  // FM 54 Set_HighCut_Mph            (1, 2, 360, 300)                    
  0x07, 0x20, 0x37, 0x01, 0x00, 0x01, 0x0F, 0xA0,                                                              // FM 55 Set_HighCut_Max            (1, 1, 4000)                          
  0x07, 0x20, 0x38, 0x01, 0x00, 0x00, 0x27, 0x10,                                                              // FM 56 Set_Highcut_Min            (1, 0, 15000)                          
  0x07, 0x20, 0x39, 0x01, 0x00, 0x01, 0x00, 0x78,                                                              // FM 57 Set_Lowcut_Max             (1, 1, 120)                          
  ...
  0x0B, 0x20, 0x3C, 0x01, 0x03, 0xE8, 0x0F, 0xA0, 0x00, 0x50, 0x00, 0x50,                                      // FM 60 Set_Stereo_Time            (1, 1000, 4000, 80, 80)                
  ...
  0x09, 0x20, 0x3F, 0x01, 0x00, 0x03, 0x00, 0xF0, 0x00, 0xC8,                                                  // FM 63 Set_Stereo_Noise           (1, 3, 240, 200)                      
  0x09, 0x20, 0x40, 0x01, 0x00, 0x03, 0x00, 0xF0, 0x00, 0xC8,                                                  // FM 64 Set_Stereo_Mph             (1, 3, 240, 200)                      
  0x05, 0x20, 0x41, 0x01, 0x00, 0x01,                                                                          // FM 65 Set_Stereo_Max             (1, 1)                                
  ...
  0x09, 0x20, 0x49, 0x01, 0x00, 0x03, 0x00, 0xA0, 0x00, 0x8C,                                                  // FM 73 Set_StHiBlend_Noise        (1, 3, 160, 140)                       
  0x09, 0x20, 0x4A, 0x01, 0x00, 0x03, 0x00, 0xA0, 0x00, 0x8C,                                                  // FM 74 Set_StHiBlend_Mph          (1, 3, 160, 140)                      
  0x07, 0x20, 0x4B, 0x01, 0x00, 0x01, 0x0F, 0xA0,                                                              // FM 75 Set_StHiBlend_Max          (1, 1, 4000)                          
  0x07, 0x20, 0x4C, 0x01, 0x00, 0x01, 0x1B, 0x58,                                                              // FM 76 Set_StHiBlend_Min          (1, 1, 7000) 
